  ...
  i18n: {
    en: {
      ...
      links: [
        ...
        { label: "Live", href: "https://covid19pink.vercel.app/" },
      ],
      content: [
        { type: "heading", text: "Project description" },
        {
          type: "paragraph",
          html: "<a href='https://covid19pink.vercel.app/' target='_blank' rel='noreferrer'>COVID19.PINK</a> provides an interactive map, infection trajectory analysis, and country dashboards for engaging people in analysing situation during the pandemic.",
        },
        ...
        { type: "paragraph", html: "React, TypeScript, Mobx, Recharts, Vercel" },
      ],
    },
    pl: {
      title: "COVID19.PINK",
      ...
      content: [
        ...
        {
          type: "paragraph",
          html: "<a href='https://covid19pink.vercel.app/' target='_blank' rel='noreferrer'>COVID19.PINK</a> oferuje interaktywną mapę, analizę trajektorii zakażeń oraz dashboardy krajów, aby ułatwić zrozumienie sytuacji pandemicznej.",
        },
